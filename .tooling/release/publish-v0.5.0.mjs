...
const TAG = 'v0.5.0'
const TARGET = 'main'
const ASSET_NAME = 'Glove-Statistics-0.5.0-release.apk'
// Built from code points so this file stays ASCII-clean: "缝手套记工 v0.5.0 — 精简：去厂房，导出图只留计件明细"
const TITLE = String.fromCodePoint(
  0x7F1D, 0x624B, 0x5957, 0x8BB0, 0x5DE5, 0x20, 0x76, 0x30, 0x2E, 0x35, 0x2E, 0x30, 0x20, 0x2014, 0x20,
...
const notesPath = join(here, 'RELEASE_NOTES_v0.5.0.md')
